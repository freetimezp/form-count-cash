...
<html lang="uk">
    ...
    <body class="bg-light">
        <main id="cash-count" class="container py-5 text-center">
            <button class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#ModalBanknotDoc">
                Зробити звіт
            </button>
        </main>
        ...
        <div
            ...
            id="ModalBanknotDoc"
            tabindex="-1"
            aria-labelledby="ModalLabelBaknotDoc"
            aria-hidden="true"
        >
